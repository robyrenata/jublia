...
import { catchError, timeout, retry, retryWhen, mergeMap, delay, take, finalize } from 'rxjs/operators';
import { map } from 'rxjs/operators';
import { Sort, Page } from '@shared/models';
...
export class ApiService {
  ...
  getData(path: string, pagination: Page = null, ordering: Sort = null, filter: object = null): Observable<any> {
